# Web Development Project 5 - *Recipe List Data Dashboard*
...
using .filter on the response data from the API. The data returned price per serving in cents so I had to change it. 
